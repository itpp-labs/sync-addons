...
class TestBase(TransactionCase):
    ...
    def test_search_read_nested(self):
        ...
        correct_result = [{
            ...
            'category_id': [{
                'id': t_category_1.id,
                'name': t_category_1.name
            }, {
                'id': t_category_2.id,
                'name': t_category_2.name
            }],
            'company_id': {
                'id': t_company_1.id,
            ...
            'category_id': [{
                'id': t_category_3.id,
                'name': t_category_3.name
            }, {
                'id': t_category_4.id,
                'name': t_category_4.name
            }],
            'company_id': {
                'id': t_company_2.id,
    ...
    def test_create_or_update_by_external_id(self):
        ...
        #
        t_company = company_obj.browse(company_obj.create_or_update_by_external_id(
            {
                'id': t_company_ext_id,
                'name': 'TestCompany'
            })[1])
        t_child_1 = partner_obj.browse(partner_obj.create_or_update_by_external_id(
            {
                'id': t_child_1_ext_id,
                'name': 'TestChild1'
            })[1])
        t_child_2 = partner_obj.browse(partner_obj.create_or_update_by_external_id(
            {
                'id': t_child_2_ext_id,
                'name': 'TestChild2'
            })[1])
        ...
        self.assertEqual(t_company.get_external_id()[
                         t_company.id].split('.', 1)[1], t_company_ext_id)
        self.assertEqual(t_child_1.get_external_id()[
                         t_child_1.id].split('.', 1)[1], t_child_1_ext_id)
        self.assertEqual(t_child_2.get_external_id()[
                         t_child_2.id].split('.', 1)[1], t_child_2_ext_id)
        #
        ...
        t_vals = {
            'name': 'John',
            'child_ids': [
                (4, t_child_1_ext_id, 0),
                (4, t_child_2_ext_id, 0)
            ],
