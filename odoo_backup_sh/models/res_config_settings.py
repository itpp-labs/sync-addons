...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            odoo_backup_sh_amazon_bucket_name=get_param(
                "odoo_backup_sh.s3_bucket_name"
            ),
            odoo_backup_sh_amazon_access_key_id=get_param(
                "odoo_backup_sh.aws_access_key_id"
            ),
            odoo_backup_sh_amazon_secret_access_key=get_param(
    ...
    def set_values(self):
        ...
        set_param(
            "odoo_backup_sh.s3_bucket_name", self.odoo_backup_sh_amazon_bucket_name
        )
        set_param(
            "odoo_backup_sh.aws_access_key_id", self.odoo_backup_sh_amazon_access_key_id
        )
        set_param(
            "odoo_backup_sh.aws_secret_access_key",
            self.odoo_backup_sh_amazon_secret_access_key,
        )
